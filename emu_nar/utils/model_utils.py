...
def validate_model_path(model_path: str) -> None:
    ...
    if "visionvq" in model_type or "visionvq" in arch:
        raise ValueError(
            ...
            "train_nar.py expects Emu3ForCausalLM weights. "
...
def freeze_backbone_if_needed(args: argparse.Namespace, wrapper: EmuNAR) -> None:
...
def build_optimizer(args: argparse.Namespace, wrapper: EmuNAR) -> torch.optim.Optimizer:
