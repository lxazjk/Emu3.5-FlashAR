> **🔦 FlashAR 系列** — [📄 项目主页](https://lxazjk.github.io/FlashAR/) · [论文](https://arxiv.org/abs/2605.09430) · **⚡ Emu3.5-FlashAR(👈 你在这)** · [LlamaGen-FlashAR](https://github.com/lxazjk/LlamaGen-FlashAR) · [项目主页仓库](https://github.com/lxazjk/FlashAR)
...
FlashAR 是一套针对不同自回归(AR)图像生成骨干的加速实现。本仓库(Emu3.5-FlashAR)对应 Emu3.5-Image:

| 仓库 | 内容 |
|---|---|
| [**⚡ Emu3.5-FlashAR**](https://github.com/lxazjk/Emu3.5-FlashAR)(本仓库) | Emu3.5-Image 实现 |
